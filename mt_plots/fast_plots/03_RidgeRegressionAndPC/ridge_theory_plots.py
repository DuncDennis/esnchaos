...
for log_reg_param in [-1, 2]:
    ...
    fig.add_trace(
        go.Scatter(x=[x_min, x_max], y=[y_min, y_max],
                   ...
                   # name="No intercept",
                   line=dict(width=4),
                   name=r"$\hat{\boldsymbol{y}}\text{ no intercept } (a)$",
                   )
    )
    ...
    line=dict(dash="dashdot", width=4),
                   name=r"$\hat{\boldsymbol{y}}\text{ unpenalized intercept } (b)$"
                   )
    )
    ...
    fig.add_trace(
        go.Scatter(x=[x_min, x_max], y=[y_min, y_max],
                   ...
                   name=r"$\hat{\boldsymbol{y}}\text{ penalized intercept } (c)$"
