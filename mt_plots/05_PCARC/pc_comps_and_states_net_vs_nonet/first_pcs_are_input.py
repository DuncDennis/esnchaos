...
for node_bias_scale, filename_extra in ((0.0, "bias_0p0"), (0.4, "bias_0p4")):
    ...
    yaxis_title = r"$\large |R(r_{\text{pc}, i}, \hat{r}_{\text{pc}, i})|$"
    ...
    # fig.show()
    file_name = f"corr_pc_components_ens__{filename_extra}.png"
    fig.write_image(file_name, scale=3)
    ...
    file_name = f"rpca_states_scatter__{filename_extra}.png"
    fig.write_image(file_name, scale=3)
    ...
    file_name = f"rpca_comps_scatter__{filename_extra}.png"
    fig.write_image(file_name, scale=3)
