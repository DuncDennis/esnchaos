...
name_of_file = "pc_max_effect_of_actfct_network"
...
def parameter_transformer(parameters: dict[str, float | int | str]):
    ...
    # modify build args according to actfct_network_combo
    sweep_value = p["actfct_network_combo"]
    if sweep_value == "linear + no network":
        p["act_fct_opt"] = "linear"
        p["n_rad"] = 0.0
