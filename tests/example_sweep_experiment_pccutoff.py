"""
Example sweep experiment with pccutoff metric to use for testing.
"""
...
def run(directory: None | pathlib.Path = None):

    name_of_file = "example_sweep_experiment_pccutoff"
